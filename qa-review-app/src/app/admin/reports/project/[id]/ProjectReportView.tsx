                                ...
                                {project.reviews.map((review: any) => (
                                    <tr key={review.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className={`px-2 inline-flex text-[10px] leading-5 font-bold rounded-full uppercase tracking-tight ${review.status !== 'SUBMITTED' ? 'bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400' :
