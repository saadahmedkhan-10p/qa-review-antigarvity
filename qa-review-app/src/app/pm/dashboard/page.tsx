                                                    ...
                                                    <div className="space-y-2">
                                                        {project.reviews.map((review: any) => (
                                                            <div key={review.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                                                ...
                                                                <div className="flex items-center gap-3">
                                                                     <span className={`px-2 py-1 text-xs font-bold rounded-full uppercase tracking-tight ${review.status !== 'SUBMITTED' ? 'bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400' :
