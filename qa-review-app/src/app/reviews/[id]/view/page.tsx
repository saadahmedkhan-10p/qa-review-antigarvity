            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6 transition-colors duration-200">
                    <div className="flex justify-between items-start mb-4">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-800 dark:text-white break-all">{review.form?.title || 'Unknown Form'}</h1>
                            <p className="text-gray-600 dark:text-gray-400 mt-2 break-all">Project: {review.project?.name || 'Unknown Project'}</p>
                        </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <div>
                            ...
                            <p className="text-gray-900 dark:text-white mt-1 break-all">{review.reviewer?.name || 'Unassigned'}</p>
                        </div>
                        <div>
                            <h3 className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase">Secondary Reviewer</h3>
                            <p className="text-gray-900 dark:text-white mt-1 break-all">{review.secondaryReviewer?.name || 'N/A'}</p>
                        </div>
                        <div>
                            <h3 className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase">Review Lead</h3>
                            <p className="text-gray-900 dark:text-white mt-1 break-all">{review.project?.lead?.name || 'Not assigned'}</p>
                        </div>
                        <div>
                            <h3 className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase">QA Contact</h3>
                            <p className="text-gray-900 dark:text-white mt-1 break-all">{review.project?.contactPerson?.name || 'N/A'}</p>
                        </div>
                        <div>
