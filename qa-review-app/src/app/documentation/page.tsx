...
export default function DocumentationPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 flex flex-col pt-16">
        ...
        <main className="flex-1 px-8 py-12 lg:px-16 max-w-4xl scroll-smooth">
          ...
          <div className="space-y-24">
            ...
            <section id="introduction" className="space-y-4 scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-3">Introduction</h2>
            ...
            <section id="system-overview" className="space-y-4 scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-3">System Overview</h2>
              <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <section id="roles-permissions" className="space-y-4 scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-3">Roles &amp; Permissions</h2>
              <p className="text-gray-700 dark:text-gray-300">
              ...
              <div className="mt-6 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden shadow-lg relative">
            ...
            <section id="adding-users" className="space-y-4 scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-3">Adding Users &amp; Roles</h2>
              <div className="space-y-4">
                <div className="flex gap-4 items-start">
                  <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 flex items-center justify-center font-bold flex-shrink-0">1</div>
                  <div>
                    <h4 className="font-bold text-gray-900 dark:text-white">Navigate to the Users Table</h4>
                    <p className="text-gray-600 dark:text-gray-400">As an Admin, click on &quot;Users&quot; from the top navigation bar.</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 flex items-center justify-center font-bold flex-shrink-0">2</div>
                  <div>
                    <h4 className="font-bold text-gray-900 dark:text-white">Create or Bulk Invite</h4>
                ...
                <div className="flex gap-4 items-start">
                  <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 flex items-center justify-center font-bold flex-shrink-0">3</div>
                  <div>
                    <h4 className="font-bold text-gray-900 dark:text-white">Assign Roles</h4>
             ...
             <section id="projects" className="space-y-4 scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-3">Projects</h2>
              <p className="text-gray-700 dark:text-gray-300">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg border-l-4 border-blue-500 mt-4">
            ...
            <section id="forms" className="space-y-4 scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-3">Forms &amp; Templates</h2>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <section id="review-cycles" className="space-y-4 scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-3">Review Cycles</h2>
              <p className="text-gray-700 dark:text-gray-300">
              ...
              <h3 className="font-bold mt-6 mb-2 text-gray-900 dark:text-white">Conducting a Review</h3>
